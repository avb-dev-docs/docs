...
<ParamField body="country_code" type="string">
  The country code to localize search results. Use ISO 3166-1 alpha-2 country codes.
</ParamField>
...
<ResponseField name="results" type="array">
  ...
  <Expandable title="Result Object Structure">
    ...
    <ResponseField name="related_index" type="array">
      An array of related search results or topics.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="links" type="array">
  An array of relevant links extracted from the search results.
</ResponseField>
...
<ResponseField name="geo_results" type="array">
  ...
  <Expandable title="Geo Result Object Structure">
    ...
    <ResponseField name="district" type="string">
      The district or area of the location.
    </ResponseField>
