...
<ParamField body="safe_search" type="string" default="moderate">
  Control the inclusion of offensive results in the search results.
  Possible values:
  <ul>
    <li>`moderate`</li>
    <li>`strict`</li>
...
<ResponseField name="image_urls" type="array">
  An array of image URLs related to the search query.
</ResponseField>

<ResponseField name="links" type="array">
  An array of additional relevant links.
</ResponseField>
