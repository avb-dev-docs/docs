...
<ParamField body="country_code" type="string">
  Specify the country code to tailor search results to a specific region.
</ParamField>
...
<ResponseField name="image_urls" type="array">
  An array of URLs for images related to the search query.
</ResponseField>

<ResponseField name="links" type="array">
  An array of relevant links related to the search query.
</ResponseField>
